...
def main():
    ...
    image_path = os.path.join(data_root, "data_set", "fruit_data")  # flower data set path
    ...
    json_str = json.dumps(cla_dict,ensure_ascii=False, indent=4)
    with open('class_indices.json', encoding='utf-8',mode='w') as json_file:
    ...
    best_acc = 0.0
    save_path = './Eca_SAM_MobileNetV2_NAdam.pth'
