...
from spatial_module import SpatialAttention
...
class Ecsam(nn.Module):
    def __init__(self,channel, k_size=3,kernel_size=7):
        super(Ecsam, self).__init__()
        self.channel_attention = eca_layer(channel=channel, k_size=k_size)
...
class InvertedResidual(nn.Module):
    def __init__(self, inp, oup, stride, expand_ratio, k_size):
        ...
        layers.append(Ecsam(oup, k_size=k_size))
